        ...
        for page_url in all_urls:
            try:
                ...
                for a in soup.select('a[href]'):
                    ...
                    if href and ('hangzhou.com.cn' in href or href.startswith('/')):
                        full_url = href if href.startswith('http') else ('https:' + href if '.com' in href or '.cn' in href else 'https://hangzhou.com.cn' + href)
